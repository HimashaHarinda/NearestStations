...
public class MapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener, GoogleApiClient.ConnectionCallbacks {
    ...
    private Double train_lat = null;
    private Double train_long = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        train_lat = getIntent().getExtras().getDouble("train_lat");
        train_long = getIntent().getExtras().getDouble("train_long");
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng latLng2;
        LatLng marker2 = new LatLng(train_lat, train_long);
        googleMap.addMarker(new MarkerOptions().position(marker2).title(train_name));
    ...
    public void onMapClick(LatLng latLng) {
        ...
        LatLng marker2 = new LatLng(train_lat, train_long);
        LatLng destinationLocation = marker2;
                ...
                switch (status.getStatusCode()) {
                    case LocationSettingsStatusCodes.SUCCESS:
                        ...
                        if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED
                            ...
                            ActivityCompat.requestPermissions(MapActivity.this, new String[]{Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_FINE_LOCATION}, PERMISSION_LOCATION_REQUEST_CODE);
                        }
                        break;
